...
-- SQL statement to join dim_customers with dbo_geography to enrich customer data with geographic information
SELECT 
...
FROM 
    dbo.customers as c  -- Specifies the alias 'c' for the dbo_customers table
LEFT JOIN
-- RIGHT JOIN
-- INNER JOIN
-- FULL OUTER JOIN
    dbo.geography g  -- Specifies the alias 'g' for the dbo_geography table
ON 
